...
function makeWordCloud(historyId) {
	historyId = Number(historyId) + 1;
	document.getElementById("searchHistory").insertRow(historyId).setAttribute("id", "tempChart");	
